function[circ,circ_L_opToep] = level_1_parallel_func_N(opToeplitz,L,M,N,Gram,parallel_prec,on_off)
...
circ_L_opToep(:,:,:,2) = -CC;
% circ_L_opToep(:,1,:,2) = -circ_L_opToep(:,1,:,2);
% keyboard
...
circ_L_opToep(:,:,:,3) = -C3;
% circ_L_opToep(:,:,1,3) = -circ_L_opToep(:,:,1,3);
